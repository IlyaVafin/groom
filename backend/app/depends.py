...
def get_order_service(order_repository: Annotated[OrderRepository, Depends(get_order_repository)], auth_service: Annotated[AuthService, Depends(get_auth_service)]):
  return OrderService(order_repository=order_repository, auth_service=auth_service)
